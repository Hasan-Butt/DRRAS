      ...
      <div className="w-full max-w-[440px] z-10">
        ...
        <div className="flex flex-col items-center mb-10 text-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-primary flex items-center justify-center shadow-lg mb-4">
            <span className="material-symbols-outlined text-white text-[32px] icon-fill">
              shield
            </span>
          </div>
        ...
        <div className="bg-white rounded-3xl p-10 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-[#434655] uppercase tracking-wider ml-1">
                Email Address
              </label>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#004ac6] transition-colors text-[20px]">
                  mail
                </span>
                <input
                  type="email"
        ...
        <div className="flex justify-center gap-6 mt-8">
          <a
            href="#"
            className="text-xs font-semibold text-slate-400 hover:text-[#004ac6] transition-colors"
          >
            Privacy Policy
          </a>
          <a
