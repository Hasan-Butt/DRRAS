        ...
        <main className="flex-1 px-6 md:px-8 py-8 space-y-8">
          ...
          <div className="flex justify-between items-end">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-semibold tracking-wider text-[#434655] uppercase">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="col-span-1 md:col-span-2 bg-white rounded-xl p-6 shadow-ambient flex flex-col justify-between relative overflow-hidden">
              ...
              <div>
                <h3 className="text-xs font-semibold text-[#434655] uppercase tracking-widest mb-1">
                  Active Disasters
                </h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-ambient flex flex-col justify-between">
              ...
              <div className="mt-4">
                <div className="w-full bg-[#e6e8ea] h-2 rounded-full">
                  <div
                    className="bg-[#004ac6] h-2 rounded-full transition-all duration-700"
                    style={{ width: `${deployedPct}%` }}
                  ></div>
                </div>
                <p className="text-xs text-[#434655] mt-1 text-right">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="col-span-1 md:col-span-2 bg-white rounded-xl p-6 shadow-ambient">
              <div className="flex justify-between items-center mb-6">
                ...
                <Link
                  href="/disasters"
                  className="text-[#004ac6] text-sm font-semibold hover:bg-[#004ac6]/10 px-3 py-1 rounded-full transition-colors"
                >
                  Details →
                </Link>
              </div>
                ...
                <div className="relative w-36 h-36">
                  <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90">
                    ...
                    <circle
                      ...
                      stroke="#004ac6"
                      strokeWidth="3.8"
                      strokeDasharray={`${deployedPct} ${100 - deployedPct}`}
                      strokeLinecap="round"
                    />
                  </svg>
